...
void kmip_print_certificate_type_mode_enum(FILE *, enum certificate_type);
void kmip_print_date_time(FILE *, int64);
void kmip_print_get_attribute_list_request_payload(FILE *, int, GetAttributeListRequestPayload *);
void kmip_print_get_attribute_list_response_payload(FILE *, int, GetAttributeListResponsePayload *);
