...
kmip_print_operation_enum(FILE *f, enum operation value)
{
    ...
    switch(value)
    {
        case KMIP_OP_CREATE:                fprintf(f, "Create"); break;
        case KMIP_OP_CREATE_KEY_PAIR:       fprintf(f, "Create Key Pair"); break;
        case KMIP_OP_REGISTER:              fprintf(f, "Register"); break;
        case KMIP_OP_REKEY:                 fprintf(f, "Rekey"); break;
        case KMIP_OP_DERIVE_KEY:            fprintf(f, "Derive Key"); break;
        case KMIP_OP_CERTIFY:               fprintf(f, "Certify"); break;
        case KMIP_OP_RECERTIFY:             fprintf(f, "Recertify"); break;
        case KMIP_OP_LOCATE:                fprintf(f, "Locate"); break;
        case KMIP_OP_CHECK:                 fprintf(f, "Check"); break;
        case KMIP_OP_GET:                   fprintf(f, "Get"); break;
        case KMIP_OP_GET_ATTRIBUTES:        fprintf(f, "Get Attributes"); break;
        case KMIP_OP_GET_ATTRIBUTE_LIST:    fprintf(f, "Get Attribute List"); break;
        case KMIP_OP_ADD_ATTRIBUTE:         fprintf(f, "Add Attribute"); break;
        case KMIP_OP_MODIFY_ATTRIBUTE:      fprintf(f, "Modify Attribute"); break;
        case KMIP_OP_DELETE_ATTRIBUTE:      fprintf(f, "Delete Attribute"); break;
        case KMIP_OP_OBTAIN_LEASE:          fprintf(f, "Obtain Lease"); break;
        case KMIP_OP_GET_USAGE_ALLOCATION:  fprintf(f, "Get Usage Allocation"); break;
        case KMIP_OP_ACTIVATE:              fprintf(f, "Activate"); break;
        case KMIP_OP_REVOKE:                fprintf(f, "Revoke"); break;
        case KMIP_OP_DESTROY:               fprintf(f, "Destroy"); break;

        case KMIP_OP_ARCHIVE:               fprintf(f, "Archive"); break;
        case KMIP_OP_RECOVER:               fprintf(f, "Recover"); break;
        case KMIP_OP_VALIDATE:              fprintf(f, "Validate"); break;
        case KMIP_OP_QUERY:                 fprintf(f, "Query"); break;
        case KMIP_OP_CANCEL:                fprintf(f, "Cancel"); break;
        case KMIP_OP_POLL:                  fprintf(f, "Poll"); break;
        case KMIP_OP_NOTIFY:                fprintf(f, "Notify"); break;
        case KMIP_OP_PUT:                   fprintf(f, "Put"); break;

        // KMIP 1.1
        case KMIP_OP_REKEY_KEY_PAIR:        fprintf(f, "Rekey Key Pair"); break;
        case KMIP_OP_DISCOVER_VERSIONS:     fprintf(f, "Discover Versions"); break;

        // KMIP 1.2
        case KMIP_OP_ENCRYPT:               fprintf(f, "Encrypt"); break;
        case KMIP_OP_DECRYPT:               fprintf(f, "Decrypt"); break;
        case KMIP_OP_SIGN:                  fprintf(f, "Sign"); break;
        case KMIP_OP_SIGNATURE_VERIFY:      fprintf(f, "Signature Verify"); break;
        case KMIP_OP_MAC:                   fprintf(f, "MAC"); break;
        case KMIP_OP_MAC_VERIFY:            fprintf(f, "MAC Verify"); break;
        case KMIP_OP_RNG_RETRIEVE:          fprintf(f, "RNG Retrieve"); break;
        case KMIP_OP_RNG_SEED:              fprintf(f, "RNG Seed"); break;
        case KMIP_OP_HASH:                  fprintf(f, "Hash"); break;
        case KMIP_OP_CREATE_SPLIT_KEY:      fprintf(f, "Create Split Key"); break;
        case KMIP_OP_JOIN_SPLIT_KEY:        fprintf(f, "Join Split Key"); break;

        // KMIP 1.4
        case KMIP_OP_IMPORT:                fprintf(f, "Import"); break;
        case KMIP_OP_EXPORT:                fprintf(f, "Export"); break;

        // KMIP 2.0
        case KMIP_OP_LOG:                   fprintf(f, "Log"); break;
        case KMIP_OP_LOGIN:                 fprintf(f, "Login"); break;
        case KMIP_OP_LOGOUT:                fprintf(f, "Logout"); break;
        case KMIP_OP_DELEGATED_LOGIN:       fprintf(f, "Delegated Login"); break;
...
kmip_print_attribute_type_enum(FILE *f, enum attribute_type value)
{
    ...
    switch(value)
    {
        ...
        fprintf(f, "Lease Time");
        break;

        case KMIP_ATTR_USAGE_LIMITS:
        fprintf(f, "Usage Limits");
        break;
        ...
        fprintf(f, "Destroy Date");
        break;

        case KMIP_ATTR_COMPROMISE_OCCURRENCE_DATE:
        fprintf(f, "Compromise Occurrence Date");
        break;

        case KMIP_ATTR_COMPROMISE_DATE:
        fprintf(f, "Compromise Date");
        break;

        case KMIP_ATTR_REVOCATION_REASON:
        fprintf(f, "Revocation Reason");
        break;
        ...
        fprintf(f, "* X-* Y-* Custom Attribute");
        break;

        case KMIP_ATTR_ALTERNATIVE_NAME:
        fprintf(f, "Alternative Name");
        break;

        case KMIP_ATTR_KEY_VALUE_PRESENT:
        fprintf(f, "Key Value Present");
        break;

        case KMIP_ATTR_KEY_VALUE_LOCATION:
        fprintf(f, "Key Value Location");
        break;
        ...
        fprintf(f, "PKCS#12 Friendly Name");
        break;
...
void
kmip_print_certificate_type_enum(FILE *f, enum certificate_type value)
{
    if(value == 0)
    {
        fprintf(f, "-");
...
void
kmip_print_storage_status_mask_enum(FILE *f, enum storage_status_mask value)
{
    char *sep = "";
    if((value & KMIP_SSM_ONLINE_STORAGE))
    {
        fprintf(f, "%sonline", sep); sep = " ";
    }
    if((value & KMIP_SSM_ARCHIVAL_STORAGE))
    {
        fprintf(f, "%sarchived", sep); sep = " ";
    }
    if((value & KMIP_SSM_DESTROYED_STORAGE))
    {
        fprintf(f, "%sdestroyed", sep); sep = " ";
    }
}

void
kmip_print_object_group_member_enum(FILE *f, enum object_group_member value)
{
    char *sep = "";
    if((value & KMIP_OGM_GROUP_MEMBER_FRESH))
    {
        fprintf(f, "%sfresh", sep); sep = " ";
    }
    if((value & KMIP_OGM_GROUP_MEMBER_DEFAULT))
    {
        fprintf(f, "%sdefault", sep); sep = " ";
    }
}
...
kmip_print_locate_request_payload(FILE *f, int indent, LocateRequestPayload *value)
{
    ...
    if (value != NULL)
    {
        ...
        fprintf(f, "%*sStorage Status Mask: ", indent + 2, "");
        kmip_print_storage_status_mask_enum(f, value->storage_status_mask);
        fprintf(f, "\n");

        fprintf(f, "%*sObject Group Member: ", indent + 2, "");
        kmip_print_object_group_member_enum(f, value->object_group_member);
        fprintf(f, "\n");
...
{
    fprintf(f, "%*sLocate Response Payload @ %p\n", indent, "", (void *)value);
...
void
kmip_print_get_attribute_list_request_payload(FILE *f, int indent, GetAttributeListRequestPayload *value)
{
    fprintf(f, "%*sGet Attribute List Request Payload @ %p\n", indent, "", (void *)value);
...
void
kmip_print_get_attribute_list_response_payload(FILE *f, int indent, GetAttributeListResponsePayload *value)
{
    fprintf(f, "%*sGet Attribute List Response Payload @ %p\n", indent, "", (void *)value);
...
kmip_print_request_payload(FILE *f, int indent, enum operation type, void *value)
{
    switch(type)
    {
        ...
        case KMIP_OP_LOCATE:
        kmip_print_locate_request_payload(f, indent, (LocateRequestPayload *)value);
        break;
        ...
        case KMIP_OP_GET_ATTRIBUTE_LIST:
        kmip_print_get_attribute_list_request_payload(f, indent, (GetAttributeListRequestPayload *)value);
        break;
...
kmip_print_response_payload(FILE *f, int indent, enum operation type, void *value)
{
    switch(type)
    {
        ...
        case KMIP_OP_LOCATE:
        kmip_print_locate_response_payload(f, indent, (LocateResponsePayload *)value);
        break;
        ...
        case KMIP_OP_GET_ATTRIBUTE_LIST:
        kmip_print_get_attribute_list_response_payload(f, indent, (GetAttributeListResponsePayload *)value);
        break;
